...
最初にSystemIDと作業日時を持つ親の「リリース作業」を登録し、作業ごとにタイムチャート、当日の体制、申請物、関連リンクを明細として管理します。入口ではリストと月間カレンダーを切り替え、SystemIDと作業状態（すべて・未完了・完了）で絞り込めます。不要なリリース作業は、確認モーダルから配下明細ごと削除できます。
